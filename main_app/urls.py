...
urlpatterns = [
    ...
    path('guitars/<int:guitar_id>/add_tuning', views.add_tuning, name='add_tuning'),
    path('guitars/<int:guitar_id>/assoc_toy/<int:accessory_id>/', views.assoc_accessory, name='assoc_accessory'),
